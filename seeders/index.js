...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'RwKBLrEF7yqc8MX',
      'isDeleted':false,
      'phone':'ewm0nrfhu8',
      'email':'Dessie.Runte@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let user = await userDb.updateOne( { 'phone':'ewm0nrfhu8' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
    userToBeInserted = {
      'password':'pQea4oSWkNSPgKl',
      'isDeleted':false,
      'phone':'wo362ygunl',
      'email':'Moriah_Schulist@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let admin = await userDb.updateOne( { 'phone':'wo362ygunl' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
...
async function seedRouteRole () {
  try {
    const routeRoles = [ 
      ...
      {
        route: '/admin/lyric/partial-update/:id',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/admin/lyric/softdelete/:id',
        role: 'User',
        method: 'PUT' 
      },
      {
      ...
      {
        route: '/admin/lyric/softdeletemany',
        role: 'User',
        method: 'PUT' 
      },
      {
      ...
      {
        route: '/device/api/v1/lyric/create',
        role: 'User',
        method: 'POST' 
      },
      {
      ...
      {
        route: '/device/api/v1/lyric/addbulk',
        role: 'User',
        method: 'POST' 
      },
      {
      ...
      {
        route: '/device/api/v1/lyric/list',
        role: 'User',
        method: 'POST' 
      },
      {
      ...
      {
        route: '/device/api/v1/lyric/count',
        role: 'User',
        method: 'POST' 
      },
      {
      ...
      {
        route: '/device/api/v1/lyric/update/:id',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/lyric/partial-update/:id',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/lyric/updatebulk',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/lyric/softdelete/:id',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/lyric/softdeletemany',
        role: 'User',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/lyric/delete/:id',
        role: 'User',
        method: 'DELETE'
      },
      {
      ...
      {
        route: '/device/api/v1/lyric/deletemany',
        role: 'User',
        method: 'POST'
      },
      {
