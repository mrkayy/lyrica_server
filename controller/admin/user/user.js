...
const getSelectObject = require('../../../utils/getSelectObject'); 
    ...
    const findAllUser = (findAllUserUsecase) => async (req,res) => {
      try{
        ...
        let result = await findAllUserUsecase({query,options,isCountOnly:req.body.isCountOnly || false},req,res);
        return responseHandler(res,result);
      }catch(error){
        return responseHandler(res,response.internalServerError({message:error.message}));
      }
  ...
  const getUser = (getUserUsecase) => async(req,res) =>{
    try{
      ...
      let options = {};
      let result = await getUserUsecase({query, options},req,res);
      return responseHandler(res,result);
    }catch(error) {
      return responseHandler(res,response.internalServerError({message:error.message}));
    }
    ...
    const updateUser = (updateUserUsecase) => async(req,res) =>{
      try{
        ...
        let query = { _id: req.params.id};
        query._id.$ne = req.user.id;
        let result = await updateUserUsecase({dataToUpdate,query},req,res);
        return responseHandler(res,result);
      }catch(error){
        return responseHandler(res,response.internalServerError({message:error.message}));
      }
    ...
    const bulkUpdateUser = (bulkUpdateUserUsecase) => async (req,res) => {
      try{
        ...
        let result = await bulkUpdateUserUsecase({dataToUpdate,query},req,res);
        return responseHandler(res,result);
      }catch(error){
        return responseHandler(res,response.internalServerError({message:error.message}));
      }
...
const partialUpdateUser = (partialUpdateUserUsecase) => async (req,res) => {
  try{
    ...
    let dataToUpdate = {...req.body || {}};
    query._id.$ne = req.user.id
    let result = await partialUpdateUserUsecase({dataToUpdate,query},req,res);
    return responseHandler(res,result);
  }catch(error){
    return responseHandler(res,response.internalServerError({message:error.message}));
  }
    ...
    const softDeleteUser = (softDeleteUserUsecase) => async (req,res) => {
      try{
        ...
        let result = await softDeleteUserUsecase({query,dataToUpdate,isWarning:req.body.isWarning || false},req,res);
        return responseHandler(res,result);
      }catch(error){
        return responseHandler(res,response.internalServerError({message:error.message}));
      }
    ...
    const deleteUser = (deleteUserUsecase) => async(req,res) => {
      try{
        ...
        let query = { _id: req.params.id};
        query._id.$ne = req.user.id;
        let result = await deleteUserUsecase({query,isWarning:req.body.isWarning || false},req,res);
        return responseHandler(res,result);
      }catch(error){
        return responseHandler(res,response.internalServerError({message:error.message}));
      }
...
const deleteManyUser = (deleteManyUserUsecase) => async(req,res) => {
    try{
      ...
      query._id.$ne = req.user.id;
      let result = await deleteManyUserUsecase({ query,isWarning:req.body.isWarning || false},req,res);
      return responseHandler(res,result);
    }catch(error){
      return responseHandler(res,response.internalServerError({message:error.message}));
    }
...
const softDeleteManyUser = (softDeleteManyUserUsecase) => async (req,res) => {
  try{
    ...
    let result = await softDeleteManyUserUsecase({query,dataToUpdate,isWarning:req.body.isWarning || false},req,res);
    return responseHandler(res,result);
  }catch(error){
    return responseHandler(res,response.internalServerError({message:error.message}));
  }
...
const updateProfile = (updateProfileUsecase) => async (req,res) => {
  try{
    let result = await updateProfileUsecase({id:req.user.id,profileData:req.body});
    return responseHandler(res,result);
  }catch(error){
    return responseHandler(res,response.internalServerError({message:error.message}));
  }
...
const getLoggedInUserInfo = (getUserUsecase) => async (req,res) =>{
  ...
  const addUser = (addUserUsecase) => async(req,res) =>{
    try{
      let result = await addUserUsecase(req,res);
      return responseHandler(res,result);
    }catch(error){
      return responseHandler(res,response.internalServerError({message:error.message}));
    }
...
module.exports = {
  addUser,bulkInsertUser,findAllUser,getUser,getUserCount,updateUser,bulkUpdateUser,partialUpdateUser,softDeleteUser,deleteUser,deleteManyUser,softDeleteManyUser,changePassword,updateProfile,getLoggedInUserInfo,addUser
}
